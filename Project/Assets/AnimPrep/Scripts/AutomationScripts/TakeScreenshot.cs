...
public class TakeScreenshot : MonoBehaviour {
	...
	void CalcPositons(Bounds bounds, Transform t){
        ...
        Vector3 v3Center = bounds.center;// Vector3.Scale(bounds.center, Vector3.one * 2);
	...
	private static Bounds CalculateLocalBounds(Transform t)	{
        ...
        bounds.center = localCenter;// funcenter;// localCenter;
	...
	public void SetFrustumToSceneObject(Transform sceneObject) {
		...
		var newZ = distance * 1.25f * Mathf.Abs( Vector3.Dot(fwd, refPos) );// 3f;// Mathf.Max(distance * 3f, closestDistance);
